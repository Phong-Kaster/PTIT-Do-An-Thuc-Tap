 ...
 *
 *
 * EDIT: custom event added: input, drop
 */
...
// see https://github.com/Modernizr/Modernizr/blob/master/feature-detects/storage/localstorage.js
    ...
    function init(self, source, options) {
        ...
        attach(self, editor, {input:"input"}, editor);
        attach(self, editor, {drop:"drop"}, editor);
        ...
        self.on("@input", function(editor, event){})
        self.on("@drop", function(editor, event){})
